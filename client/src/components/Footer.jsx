        ...
        <Footer container className='border border-t-8 border-teal-500'>
            <div className='w-full max-w-7xl mx-auto'>
                <div className='grid w-full justify-between sm:flex md:grid-cols-1'>
                    ...
                    <div className='grid grid-cols-2 gap-8 mt-4 sm:grid-cols-3 sm:gap-6'>
                        ...
                        <div>
                            ...
                            <Footer.LinkGroup col>
                                <Footer.Link href='https://www.github.com/flibouche' target='_blank' rel='noopener noreferrer'>
                                    GitHub
                                </Footer.Link>
                                <Footer.Link href='#'>
                                    Discord
                ...
                <div className='w-full sm:flex sm:items-center sm:justify-between'>
                    <Footer.Copyright href='#' by="Flibouche's Blog" year={new Date().getFullYear()} />
                    <div className='flex gap-6 mt-4 sm:mt-0 sm:justify-center'>
                        <Footer.Icon href='#' icon={BsFacebook} />
                        <Footer.Icon href='#' icon={BsInstagram} />
                        <Footer.Icon href='#' icon={BsTwitterX} />
                        <Footer.Icon href='https://github.com/flibouche' icon={BsGithub} />
                    </div>
                </div>
            </div>
        </Footer>
